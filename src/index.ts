...
function preferences(args: String) {
  let prefDefaults = [
    ...
    ["free.acc3", "Lucky gold ring", "Freefight outfit Accessory (3) (this will be flexed out for accessoies as needed in some free fights)"],
    ["free.familiar", "Loathing Legion Helicopter", "Freefight outfit Familiar Eqiupment (will be equipped if possible)"],
    ...
    ["bk.acc3", "Ring of the Skeleton Lord", "Bosskilling outfit Accessory (3) (this will be flexed out for Lil Doctor Bag as needed)"],
